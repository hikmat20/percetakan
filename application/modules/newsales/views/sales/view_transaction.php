        ...
        <tbody>
            ...
            foreach ($data as $dt) : $n++ ?>
                <tr>
                    ...
                    <td class="text-center text-primary"><?= ucfirst($users[$dt->created_by]); ?></td>
                    ...
                    <td class="text-center">
                        ...
                        <?php if ($dt->status == 'OPN' || $dt->status == 'PND') : ?>
                            ...
                            <button type="button" onclick="cancel('<?= $dt->id; ?>')" class="btn btn-light-danger text-danger btn-icon btn-xs cancel" title="Batal"><i class="fa fa-times-circle"></i></button>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; ?>
