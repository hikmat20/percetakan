...
<input type="hidden" name="product_id" id="product" class="form-control form-control-sm" value="">
<div class="">
  <div class="row mb-2">
    <div class="col-lg-8">
      <label for="" class="form-label text-primary">Bahan</label>
      <select class="form-select form-select-sm select" name="product_detail_id" id="product_detail">
        <option value="">~ Pilih Bahan ~</option>
        <?php foreach ($products_details as $pro) : ?>
          <option value="<?= $pro->id; ?>" <?= ($dtlId == $pro->id) ? 'selected' : ''; ?>><?= $pro->name; ?></option>
        <?php endforeach; ?>
      </select>
    </div>
    <div class="col-md-4">
