		...
		<tbody>
			...
			foreach ($trans_details as $dt) : $n++ ?>
				<tr>
					<td><?= $n; ?></td>
					<td>
						<span class="fw-bold"><?= $dt->material_name; ?></span><br>
...
<div class="row">
	...
	<div class="col-md-3">
		<button type="button" class="btn btn-light-primary text-primary fw-light btn-icon" title="Print Struk" data-id="<?= $transactions->id; ?>" id="print_bill"><i class="fa fa-print"></i></button>
	</div>