...
!(function () {
   if (
      ...
      $(".nav-scroller").length && $(".nav-scroller").slimScroll({ height: "90%" }),
   ...
   if ($("#perfomanceChart").length) {
      new ApexCharts(document.querySelector("#perfomanceChart"), {
         ...
         plotOptions: { radialBar: { startAngle: -168, endAngle: -450, hollow: { size: "55%" }, track: { background: "transaprent" }, dataLabels: { show: !1 } } },
      }).render();
   }
   if ($(".offcanvas").length)
